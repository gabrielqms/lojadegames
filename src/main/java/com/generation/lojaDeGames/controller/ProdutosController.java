...
public class ProdutosController {
	...
	@PutMapping
	public ResponseEntity<Produtos> put(@Valid @RequestBody Produtos postagem){
		if(produtosRepository.existsById(postagem.getId())) {
			
			if(categoriaRepository.existsById(postagem.getCategoria().getId()))
				return ResponseEntity.status(HttpStatus.OK)
						.body(produtosRepository.save(postagem));
